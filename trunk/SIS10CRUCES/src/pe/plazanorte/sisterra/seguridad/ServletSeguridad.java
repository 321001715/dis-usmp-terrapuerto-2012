	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(tipo.equalsIgnoreCase("registrar")) {
			...
			try {
				...
				if(retorno) mensaje = "Usuario modificado con �xito.";
		...
		//*****************************INICIO MANTENER PERFIL*****************************//
			...
			try {
				...
				if(retorno) mensaje = "Perfil agregado con �xito.";
			...
			try {
				...
				if(retorno) mensaje = "Perfil modificado con �xito.";
			...
			if(tipo.equalsIgnoreCase(Constantes.ACCION_RECUPERAR_CONTRASENA)){
				...
				try {
					...
					message.setText("Estimado: " + usuVal.getNombres()
							+ "\n\n Su contrase�a es: " + usuVal.getClave());
