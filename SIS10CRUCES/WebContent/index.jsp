...
<body>
	...
	<h2>Men&uacute; principal</h2>
		<ul>
			...
			<li><a href="<%=application.getContextPath() %>/ServletProveedor?tipo=<%=Constantes.ACCION_LISTAR_PROVEEDOR %>&destino=<%=Constantes.MANTENER_PROVEEDOR%>">Gestion de Veh&iacute;culos</a></li>
        </ul>
</body>
</html>