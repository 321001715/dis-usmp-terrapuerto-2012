...
<br>
	...
	<h2 style="font-family: verdana">HA OCURRIDO UN ERROR 404</h2>

	No  se a encontrado la página requerida

	<p><a href="<%=request.getContextPath()%>/home.jsp">Volver a la página principal</a></p>
